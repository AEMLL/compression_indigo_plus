...
def main():
    ...
    parser.add_argument(
            "--config_indigo",
            type=str,
            default="configs/sample/indigo.yaml",
            help='Random Seed',
            )
    ...
    configs_indigo = OmegaConf.load(args.config_indigo)
    ...
    sampler_dist = CompressionSampler(
            configs,configs_indigo,
    ...
    sampler_dist.inference(
            ...
            bs=args.bs,
            start_timesteps=configs_indigo.start_timesteps,
            task=args.task,
